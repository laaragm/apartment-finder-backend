...
namespace ApartmentFinder.Infrastructure.Migrations
{
    ...
    [Migration("20231228172941_Create_Database3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Apartments.Apartment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Bookings.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Apartments.Apartment", b =>
                {
                    b.OwnsOne("ApartmentFinder.Domain.Apartments.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Shared.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Shared.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Bookings.Booking", b =>
                {
                    b.HasOne("ApartmentFinder.Domain.Apartments.Apartment", null)
                        .WithMany()
                        .HasForeignKey("ApartmentId")
                    ...
                    b.HasOne("ApartmentFinder.Domain.Users.User", null)
                        .WithMany()
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Shared.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Shared.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("ApartmentFinder.Domain.Bookings.DateRange", "Duration", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("ApartmentFinder.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("ApartmentFinder.Domain.Bookings.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
