...
// For the query responses we want to use primitive types as much as possible and we want a very flat structure which we can easily return from the database
